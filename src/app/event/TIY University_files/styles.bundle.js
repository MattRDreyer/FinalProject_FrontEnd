...
// module
exports.push([module.i, "\n\n/* body{\nbackground-image: repeating-linear-gradient(\n    45deg, orange 1px, \t#F0F8FF 0.5px, transparent 30px\n);\n} */\n\n\n\n\n/* Customize container */\n\n@media (min-width: 600px) {\n    .container {\n        /*max-width: 768px;*/\n        max-width: 100%;\n        width: 100%;\n    }\n}\n\n@media (min-width: 800px) {\n    .container-fluid {\n        max-width: 100%;\n    }\n}\n\n/* Validation formatting */\n\n.ng-valid[required], .ng-valid.required  {\n  border-left: 5px solid #42A948; /* green */\n}\n.ng-invalid:not(form)  {\n  border-left: 5px solid #a94442; /* red */\n}\n\n#deletemsg {\n    margin-top: 75px;\n}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js??ref--9-1!../../postcss-loader/index.js??postcss!./buttons.dataTables.css", function() {
			var newContent = require("!!../../css-loader/index.js??ref--9-1!../../postcss-loader/index.js??postcss!./buttons.dataTables.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__("../../../../datatables.net-buttons-dt/css/buttons.dataTables.css");
